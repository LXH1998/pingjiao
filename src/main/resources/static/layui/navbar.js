                ...
                for (var j = 0; j < data[i].children.length; j++) {
                    ...
                    if (data[i].children[j].children !== undefined && data[i].children[j].children !== null && data[i].children[j].children.length > 0) {
                        ...
                        for (var k = 0; k < grandsonNodes.length; k++) {
                            ulHtml += '<dd>';
                             ulHtml += '<a data-url="' + grandsonNodes[k].href + '" data-id="'+  grandsonNodes[k].id + '" data-title="'+ grandsonNodes[k].title+'"href="#" ' +
                            'class="site-demo-active" data-type="tabAdd">' + grandsonNodes[k].title;
                            ulHtml += '</dd>';
                        }
                        ulHtml += '</dl>';
                        ulHtml += '</dd>';
                        ...
                        ulHtml += '<dd>';
                        ulHtml += '<a data-url="' + data[i].children[j].href + '" data-id="'+  data[i].children[j].id + '" data-title="'+data[i].children[j].title+'"href="#" ' +
                            'class="site-demo-active" data-type="tabAdd">' + data[i].children[j].title;
                        ulHtml += '</a>';
                        ulHtml += '</dd>';
                    }
